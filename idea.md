...
## Deskripsi Ide 
Dari user story tersebut, kami memiliki ide untuk membuat sebuah aplikasi berbasis web bernama Kantin IPB. Kantin IPB adalah aplikasi informatif yang memiliki informasi seputar kantin di IPB. Dimulai dari menu, harga, lokasi dan jam operasional dari seluruh kantin di IPB hingga nutrisi dari menu yang disajikan. 

Ada 2 fitur yang disediakan oleh aplikasi Kantin IPB, yaitu search dan sort. Search digunakan ketika pengguna ingin mencari makanan berdasarkan keyword tertentu. Sort digunakan ketika pengguna ingin mengurutkan makanan dengan memilih kategori tertentu seperti harga, nutrisi atau lokasi.
